...
namespace EasyLocBaml
{
    ...
    internal class Abbrevs
    {
        ...
        private readonly bool[] canHaveValue;
        private readonly bool[] requiresValue;

        public Abbrevs(String[] aOptions)
        {
            options = new String[aOptions.Length];
            requiresValue = new bool[aOptions.Length];
            canHaveValue = new bool[aOptions.Length];
    ...
    internal class CommandLine
    {
        ...
        private readonly Option[] optList;
        private readonly Abbrevs validOptions;
        private int argCursor;
        ...
        public int NumOpts
        {
            get { return optList.Length; }
        }

        public String GetNextArg()
        {
            if (argCursor >= argList.Length)
                return null;
            return argList[argCursor++];
        }

        public Option GetNextOption()
        {
            if (optCursor >= optList.Length)
                return null;
            return optList[optCursor++];
        }
    }
}